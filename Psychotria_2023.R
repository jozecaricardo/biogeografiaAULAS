...
################################################################
#######################################################
# Constant geography (geography only): DIVALIKE
#######################################################
#######################################################
...
###############################################################
###############################################################
#  dispersal multiplier matrix: DEC model
###############################################################
...
#######################################################
#  dispersal multiplier matrix: DEC+j model
#######################################################
BioGeoBEARS_run_object = define_BioGeoBEARS_run()
BioGeoBEARS_run_object$trfn = trfn
BioGeoBEARS_run_object$geogfn = geogfn
...
#######################################################
# MODELS + x
# 1 parâmetro livre, além da dispersão e extinção: x é a potência do ajuste da distância
#######################################################
#######################################################
# Run DEC
#######################################################
...
# Uncomment files you wish to use in time-stratified analyses:
#BioGeoBEARS_run_object$timesfn = "timeperiods.txt"
BioGeoBEARS_run_object$dispersal_multipliers_fn = np(paste(addslash(extdata_dir), "examples/Psychotria_M3strat/BGB/dispersal_multipliers_for_+w_model.txt", sep=""))
#BioGeoBEARS_run_object$areas_allowed_fn = "areas_allowed.txt"
#BioGeoBEARS_run_object$areas_adjacency_fn = "areas_adjacency.txt"
BioGeoBEARS_run_object$distsfn = np(paste(addslash(extdata_dir), "examples/Psychotria_M3strat/BGB/distances_matrix.txt", sep=""))
# See notes on the distances model on PhyloWiki's BioGeoBEARS updates page.
...
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["x","min"] = -10.0
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["x","max"] = 10.0
...
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["w","min"] = -10.0
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["w","max"] = 10.0
...
# load the saved result.
runslow = TRUE
resfn = "Psychotria_DEC_M2a_oneWayDispersal+w+x_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
# Set up a time-stratified analysis:
#BioGeoBEARS_run_object$timesfn = "timeperiods.txt"
BioGeoBEARS_run_object$dispersal_multipliers_fn = "/drives/Dropbox/201207\ Biogeobears\ Instructor/201207\ Biogeobears\ Participants/lab03/dispersal_multipliers_for_+w_model.txt"
#BioGeoBEARS_run_object$areas_allowed_fn = "areas_allowed.txt"
#BioGeoBEARS_run_object$areas_adjacency_fn = "areas_adjacency.txt"
BioGeoBEARS_run_object$distsfn = "/drives/Dropbox/201207\ Biogeobears\ Instructor/201207\ Biogeobears\ Participants/lab03/distances_matrix.txt"
# See notes on the distances model on PhyloWiki's BioGeoBEARS updates page.
...
resfn = "Psychotria_DEC+J_M2a_oneWayDispersal+w+x_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Psychotria_DEC_vs_DEC+J_M2a_oneWayDispersal+w+x_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Psychotria M2a_oneWayDispersal+w+x"
...
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Psychotria M2a_oneWayDispersal+w+x"
